...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect'):
        ...
        self.attn_gated1 = Attention_block(ngf * 2,ngf*2,int(ngf/2))
        self.attn_gated2 = Attention_block(ngf * 4,ngf*4,ngf)
        ...
        self.upsample = nn.Upsample(size=(256, 512), mode='bilinear')
