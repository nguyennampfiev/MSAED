...
class ResnetGenerator(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect'):
        ...
        self.upsample = nn.Upsample(size=(128, 256), mode='bilinear')
    ...
    def forward(self, input, isTrain):
        ...
        attn2, psi2 = self.attn_gated2(resnet,down2)
        up2 = self.up2(torch.cat((resnet,attn2),dim=1))
        #### up2 64*4 down1 64*2 --> 384 
        attn1, psi1 = self.attn_gated1(up2,down1)
...
class L1Weight(nn.Module):
    ...
    def forward(self, weight, real, fake):
        """
        :param real: real_img
        :param fake: fake_img
        :param weight:
